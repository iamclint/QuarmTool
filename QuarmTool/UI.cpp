...
void UI::Render()
{
    ...
    const WNDCLASSEX wc = { sizeof(WNDCLASSEX), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(nullptr), nullptr, nullptr, nullptr, nullptr, _T("Quarmtool"), nullptr };
    ::RegisterClassEx(&wc);
    const HWND hwnd = ::CreateWindow(wc.lpszClassName, _T("Quarmtool"), WS_OVERLAPPEDWINDOW, 100, 100, 50, 50, NULL, NULL, wc.hInstance, NULL);
    ...
    bool bDone = false;
    QuarmTool qt;
    //MessageBoxA(nullptr, "WTF", "wtf2", 0);
    while (!bDone)
    {
        MSG msg;
